...
NAME=centos7
ISO_URL=http://mirror.us.leaseweb.net/centos/7.0.1406/isos/x86_64/CentOS-7.0-1406-x86_64-NetInstall.iso
...
## Run KVM and install CentOS 7
##
## NOTE:
##   1. CentOS installation CD starts with a graphic screen,
