...
NAME=trisquel601
ISO_URL=http://mirror.fsf.org/trisquel-images/trisquel-netinst_6.0.1_amd64.iso
...
## Run KVM and install Trisquel 6.0.1
##
## NOTES:
##  1. Trisquel requires VGA adapter (even though the installer is 'text')
kvm -name "$NAME" \
    -m "$RAM" \
