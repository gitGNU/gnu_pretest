...
NAME=gnewsense31
ISO_URL=http://archive.gnewsense.org/gnewsense-three/gnewsense/dists/parkes/main/installer-amd64/current/images/netboot/mini.iso
...
## Run KVM and install gNewSense 3.1
##
## NOTE:
##   1. gNewSense installation CD starts with a graphic screen,
