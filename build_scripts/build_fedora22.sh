...
ISO_URL=https://download.fedoraproject.org/pub/fedora/linux/releases/22/Server/x86_64/iso/Fedora-Server-DVD-x86_64-22.iso
...
## Run KVM and install Fedora 22
##
## NOTE:
##   1. Fedora22 installation CD starts with a graphic screen,
