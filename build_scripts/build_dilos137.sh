...
NAME=dilos137
ISO_URL=http://apt2.dilos.org/dilos/isos/dilos-core_install-14-09-19_17-23-1.3.7.18.iso
...
## Run KVM and install Dilos 1.3.7.18
##
## NOTE:
##   1. DilOS installer works with "-curses"
##   2. DilOS requires "-machine pc-1.1", otherwise boot hangs forever.
kvm -name "$NAME" \
    -m "$RAM" \
