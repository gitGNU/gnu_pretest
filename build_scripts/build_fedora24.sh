...
NAME=fedora24
ISO_URL=https://download.fedoraproject.org/pub/fedora/linux/releases/24/Server/x86_64/iso/Fedora-Server-dvd-x86_64-24-1.2.iso
...
## Run KVM and install Fedora 24
##
## NOTE:
##   1. Fedora23 installation CD starts with a graphic screen,
##      "-curses" can not be used for initial installation.
##   2. Fedora20 installer requires 512MB of ram
kvm -name "$NAME" \
    -m "$RAM" \
